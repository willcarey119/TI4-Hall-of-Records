...
// Verbatim copy of TI Assistant JSON schema. The `any` in GameEventPayload.event
// is intentional — callers must narrow it with type guards at the parser boundary.
